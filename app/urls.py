...
urlpatterns = [
    ...
    path('regsitration/',views.CustomerRegistrationView.as_view(),name='customerregistration'),
...
admin.site.site_header="Neha Dairy"
admin.site.site_title="Neha DairyS"
admin.site.site_index_title="Welcome to Neha (E-Commerce) Dairy Products"